  ...
  return (
    <div className="space-y-2 pt-2 md:pt-6 pb-8 md:space-y-5">
      <NextSeo
        ...
        description="PixiBoom's is free website and it provides AI-powered tools for creators, without collecting any sort of personal user data."
      />
      <article>
        <div>
          <header>
          ...
          >
            <div className="divide-y divide-gray-200 dark:divide-gray-700 xl:col-span-3 xl:row-span-2 xl:pb-0">
              <div className="prose max-w-none pt-10 pb-8 dark:prose-dark prose-lg">
                ...
                <ul>
                  ...
                  <li>
                    <p>
                      ...
                      Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                      &quot;Our&quot; in this Agreement) refers to PixiBoom,
                      B-180 Govindpuri Kalkaji, DL 110019.
                    </p>
                  </li>
                  <li>
                    <p>
                  ...
                  <li>
                    <p>
                      <strong>Website</strong> refers to PixiBoom, accessible
                      from{" "}
                      <Link
                        href="/"
                ...
                <ul>
                  <li>
                    <p>By email: draj123258@gmail.com</p>
                  </li>
                  <li>
                    <p>
