  ...
  return (
    <>
      <NextSeo
        ...
        description="Adopt the perfect twitter bio for your profile with this AI-powered twitter bio generator! Enhance your presence on the platform today with a few simple clicks."
      />
