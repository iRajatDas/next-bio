  ...
  return (
    <>
      ...
      <div className="">
        <div className="space-y-2 pt-6 pb-8 md:space-y-5">
          ...
          <p className="text-lg leading-7 text-gray-500 dark:text-gray-400">
            With just a few clicks, you'll create the perfect bio to make your profile stand out. Take control of your online presence with this easy-to-use Facebook bio generator tool!
          </p>
        </div>
      ...
      <div className="prose max-w-none pt-10 pb-8 dark:prose-dark">
        ...
        <p>A Facebook bio: what are they? In Facebook , your bio is a brief description of yourself or your business located underneath your username.</p>
        <p>Facebook allows you to include a short description, contact information, emojis, and more in your profile or page bio.</p>
        <h3>Facebook Bio Checklist</h3>
        <p>Make sure your profile is totally on point! Follow this checklist to optimize your Facebook bio and enhance your online presence:</p>
        <ul>
